...
const BookingPage: React.FC = () => {
  ...
  const handleServiceChange = (
    serviceType: "reels" | "story" | "reelsStory",
    value: string
  ) => {
  ...
  const handleBookerDetailsChange = (
    ...
    switch (step) {
      ...
      case 2:
        if (
          ...
          isValid = false;
          errorMessage =
            "Please fill in all your details (Full Name, Email, Phone Number).";
  ...
  const ServiceCard = ({
    ...
    >
      <div className="text-center md:text-left mb-4 md:mb-0 flex-grow">
        <Label htmlFor={type} className="text-xl font-semibold mb-1 block">
          {label}
        </Label>
        <p className="text-gray-600 text-sm mb-2">{description}</p>
        <p className="text-purple-500 text-2xl font-extrabold">
              ...
              <div className="flex justify-between items-center">
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    {services.reels + services.story + services.reelsStory}{" "}
                    service(s) selected
                  </p>
                </div>
            ...
            <div className="bg-purple-50 p-4 rounded-lg border border-purple-200 mt-2">
              <div className="flex">
                ...
                <p className="text-sm text-purple-700">
                  We&apos;ll send booking confirmation and payment details to
                  this email and phone number. Double-check for accuracy.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
                ...
                {creator.profilePictureUrl && (
                  <Image
                    ...
                    onError={(e) => {
                      ...
                      target.onerror = null;
                      target.src = `https://placehold.co/64x64/EEE2FE/6B21A8?text=${creator.fullName.charAt(
                        0
                      )}`;
                    }}
                  />
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-2 text-sm text-gray-700">
                ...
                <div>
                  ...
                  {parseInt(creator.totalFollowers).toLocaleString()}
                </div>
                <div>
                  <span className="font-medium text-gray-600">
                    Avg. Reel Views:
                  </span>{" "}
                  {parseInt(creator.avgReelViews).toLocaleString()}
                </div>
                <div>
                  <span className="font-medium text-gray-600">
                    Avg. Story Views:
                  </span>{" "}
                  {parseInt(creator.storyAverageViews).toLocaleString()}
                </div>
                <div>
                  <span className="font-medium text-gray-600">Delivery:</span>{" "}
                  {creator.deliveryDuration} days
                </div>
              </div>
            </div>
                ...
                {services.reels > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      ₹
                      {(
                        getPrice(creator.reelPrice) * services.reels
                ...
                {services.story > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      ₹
                      {(
                        getPrice(creator.storyPrice) * services.story
                      ).toLocaleString("en-IN")}
                    </span>
                  </div>
                )}
                {services.reelsStory > 0 && (
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      ₹
                      {(
                        getPrice(creator.reelsStoryPrice) * services.reelsStory
                      ).toLocaleString("en-IN")}
                    </span>
                  </div>
                )}
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <p className="font-medium">
                      {bookerDetails.fullName || "N/A"}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Email</p>
                    <p className="font-medium">
                      {bookerDetails.email || "N/A"}
                    </p>
                  </div>
                  <div>
                    <p className="text-sm text-gray-500">Phone</p>
                    <p className="font-medium">
                      {bookerDetails.phoneNumber || "N/A"}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-green-50 rounded-xl p-6 border border-green-200">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    You can view your bookings in the &quot;My Orders&quot;
                    section
                  </p>
                  <div className="mt-8 bg-purple-50 p-4 rounded-lg border border-purple-200">
                    ...
                    <div className="flex flex-col items-start text-left space-y-2 text-sm text-purple-700">
                      ...
                      <p className="flex items-center">
                        ...
                        <a href="tel:+917084989378" className="hover:underline">
                          +91 70849 89378
                        </a>
                      </p>
                      <p className="flex items-center">
