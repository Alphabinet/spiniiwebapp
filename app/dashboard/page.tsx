...
import {
  ...
  ChevronDownIcon, // Added for expand/collapse icon
  ChevronUpIcon,   // Added for expand/collapse icon
...
export default function OverviewPage() {
  ...
  const [showNotifications, setShowNotifications] = useState(false); // New state for toggling visibility
    ...
    return (
      <div className="container mx-auto px-4 py-8 space-y-8 mb-24">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          {/* NEW: Collapsible Notifications Section (Right Column) */}
          <div className="lg:col-span-1 space-y-6">
            <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border border-gray-100">
              ...
              {showNotifications && ( // Conditionally render content when expanded
                <>
                  ...
                  {notificationsLoading ? (
                    ...
                    <ul className="space-y-3 max-h-96 overflow-y-auto pr-2"> {/* Added max-height and overflow */}
  ...
  return (
    <div className="container mx-auto px-4 py-8 space-y-8 mb-24">
      ...
      {user && (
        // NEW: Collapsible Notifications Section for Normal User
        <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl border border-gray-100 mt-8">
            <div className="flex items-center justify-between mb-4">
                <h3 className="text-lg font-bold text-gray-900 flex items-center gap-2">
                    <BellAlertIcon className="w-6 h-6 text-purple-600" /> Notifications
